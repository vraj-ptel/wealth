...
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('INCOME', 'EXPENCE');

-- CreateEnum
CREATE TYPE "ReCurringIntervel" AS ENUM ('MONTHLY', 'WEEKLY', 'YEARLY', 'DAILY');
...
CREATE TABLE "transactions" (
    ...
    "reCurringIntervel" "ReCurringIntervel",
